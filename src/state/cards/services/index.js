...
export const getCards = () =>
	fakeHttpModule.get("v1/cards?expand=creator,likes", undefined, undefined, TYPES.json);
...
export const getCardsSearch = ({ payload: query }) =>
	fakeHttpModule.get(`v1/cards?expand=creator,likes&search=${query}`, undefined);
...
export const filterCardsByCategory = ({ payload: categoryId }) =>
	fakeHttpModule.get(`v1/cards?expand=creator,likes&categoryId=${categoryId}`, undefined);
...
export const filterCardsByUserCreator = ({ payload: { creatorId } }) =>
	fakeHttpModule.get(
		`v1/cards?expand=creator,likes&creatorId=${creatorId}`,
		undefined,
		undefined,
		TYPES.json,
	);
